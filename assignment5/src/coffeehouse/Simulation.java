...
public class Simulation {
	...
	//current space 
	public static AtomicInteger currentSpace;
	//lock for cook
	...
	public static XiaoCaseList<Order> orderList;// this is the list for homework 8!!!!!!
	
	//a running filed for order ready for delivery
	public static ConcurrentMap<Integer, Order> readyOrder = new ConcurrentHashMap<Integer, Order>();
	...
	public static List<SimulationEvent> runSimulation(
		...
		currentSpace=new AtomicInteger(numTables);
		orderList= new XiaoCaseList<Order>();
